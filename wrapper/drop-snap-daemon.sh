...
# pcds-kiosk dependent directories
...
if [[ ! -d $SNAP_DAEMON_HOME/.config/pcds || "$UPDATE_REQUIRED" = "true" || "$MISSING_DIR_COPY" = "true" ]]
then
  mk_snap_daemon_dir $SNAP_DAEMON_HOME/.config/pcds
fi
